...
" /* Enable folding */
set foldlevel=99
" Press <space> to hide or display code block
nnoremap <space> za
...
" Code AutoFormat (Press F6 to autofomat code, maybe only support python)
...
" /* for SimpylFold */
let g:SimpylFold_docstring_preview = 1 " display docString after code folded
